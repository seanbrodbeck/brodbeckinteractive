...
if ( ! function_exists( 'bi_setup' ) ) :
	...
	function bi_setup() {
		 ...
		 * If you're building a theme based on bi, use a find and replace
		 * to change 'bi' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'bi', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'bi_custom_background_args', array(
...
add_action( 'after_setup_theme', 'bi_setup' );
 ...
 */
function bi_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'bi_content_width', 640 );
}
add_action( 'after_setup_theme', 'bi_content_width', 0 );
 ...
 */
function bi_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bi' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bi' ),
...
add_action( 'widgets_init', 'bi_widgets_init' );
